...
export default {
  name: LibraryEnum.deleteLibraryTTS,
  components: {
    Icon,
  },
  setup() {
...
<template>
  <div class="form">
    ...
    <div class="form-content-field-delete">
      ...
      <p><Icon :name="Icons.IconOutlineHeadsetMic"  class="icon"/> {{deleteCurrentLibrary.nom_diffusion}}</p>
    </div>
    ...
    <div class="form-content-field-delete">
      ...
      <p>{{deleteCurrentLibrary.nom_lang}}</p>
    </div>
    ...
    <div class="form-content-field-delete">
      ...
      <p>{{deleteCurrentLibrary.contenu_tts}}</p>
    </div>
